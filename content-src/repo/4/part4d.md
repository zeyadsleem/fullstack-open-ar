...
![sequence diagram of token-based authentication](../../images/4/16new.webp)
...
![vscode rest post with username/password](../../images/4/17e.webp)
...
![vs code rest response showing details and token](../../images/4/18ea.webp)

A wrong username or password returns an error message and the proper status code:

![vs code rest response for incorrect login details](../../images/4/19ea.webp)
...
![postman adding bearer token](../../images/4/20new.webp)

and with Visual Studio Code REST client

![vscode adding bearer token example](../../images/4/21new.webp)
...
![browser api/users shows JSON data of two users](../../images/4/22.webp)
...
![api/blogs embeds creators user information in JSON data](../../images/4/23e.webp)

and listing all users also displays the blogs created by each user:

![api/users embeds blogs in JSON data](../../images/4/24e.webp)
