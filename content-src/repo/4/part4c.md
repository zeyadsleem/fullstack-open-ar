...
![browser api/users shows JSON data with notes array](../../images/4/9.webp)
...
![Postman creating a new note](../../images/4/10e.webp)

The operation appears to work. Let's add one more note and then visit the route for fetching all users:

![api/users returns JSON with users and their array of notes](../../images/4/11e.webp)
...
![api/notes shows ids of users in JSON](../../images/4/12e.webp)
...
![JSON data showing populated notes and users data with repetition](../../images/4/13new.webp)
...
![combined data showing no repetition](../../images/4/14new.webp)
...
![notes JSON now has user info embedded too](../../images/4/15new.webp)
