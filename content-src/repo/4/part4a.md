...
![terminal output from npm test with all tests passing](../../images/4/1new.webp)
...
![terminal output shows failure from npm test](../../images/4/2new.webp)
...
![terminal output showing empty array fails](../../images/4/3new.webp)
...
![screenshot of npm test showing describe blocks](../../images/4/4new.webp)
...
![npm test passing for list_helper_test](../../images/4/5.webp)
