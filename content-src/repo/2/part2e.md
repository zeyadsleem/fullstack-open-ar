...
![error removed from server screenshot from app](../../images/2/26e.webp)
...
![successful green added screenshot](../../images/2/27e.webp)
...
![error message 404 not found when changing multiple browsers](../../images/2/29b.webp)
...
![error message shown on screen instead of in console feature add-on](../../images/2/28e.webp)
...
![console typerror cannot read properties of null via map from App](../../images/2/31a.webp)
...
![browser showing currency exchange rates with eur typed and console saying fetching exchange rates](../../images/2/32new.webp)
...
![too many matches screenshot](../../images/2/19b1.webp)

If there are ten or fewer countries, but more than one, then all countries matching the query are shown:

![matching countries in a list screenshot](../../images/2/19b2.webp)

When there is only one country matching the query, then the basic data of the country (eg. capital and area), its flag and the languages spoken are shown:

![flag and additional attributes screenshot](../../images/2/19c3.webp)
...
![attach show buttons for each country feature](../../images/2/19b4.webp)
...
![weather report added feature](../../images/2/19x.webp)
