...
![browser showing dev react tools window](../../images/2/30.webp)
...
![button clicked with form object console](../../images/2/6e.webp)
...
![provided value to prop without onchange console error](../../images/2/7e.webp)
...
![multiple console calls with typing text](../../images/2/8e.webp)
...
![state changes in react devtools shows typing too](../../images/2/9ea.webp)
...
![screenshot of 2.6 finished](../../images/2/10e.webp)
...
![browser alert: "user already exists in the phonebook"](../../images/2/11e.webp)
...
![2.8 sample screenshot](../../images/2/12e.webp)

<h4>2.9*: The Phonebook Step 4</h4>

Implement a search field that can be used to filter the list of people by name:

![2.9 search field](../../images/2/13e.webp)
