...
![data json output in console](../../images/2/20new.webp)
...
![dev tools header shows 201 created for localhost:3001/notes](../../images/2/21new1.webp)
...
![devtools payload tab shows content and important fields from above](../../images/2/21new2.webp)

Also the tab <i>response</i> is useful, it shows what was the data the server responded with:

![devtools response tab shows same content as payload but with id field too](../../images/2/21new3.webp)
...
![JSON data output from backend](../../images/2/22.webp)
...
![404 not found error in dev tools](../../images/2/23e.webp)
...
![2.17 window confirm feature screeshot](../../images/2/24e.webp)
...
![2.18 screenshot alert confirmation](../../images/teht/16e.webp)
