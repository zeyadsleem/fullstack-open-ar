...
![A screenshot of the developer tools open in a browser](../../images/0/1e.webp)
...
![Screenshot of the developer console showing these two events](../../images/0/2e.webp)
...
![Detailed view of a single event](../../images/0/3e.webp)
...
![Screenshot of response headers](../../images/0/4e.webp)
...
![Screenshot of the response tab](../../images/0/5e.webp)
...
![Detailed view of the second event](../../images/0/6e.webp)
...
![Sequence diagram of the flow covered above](../../images/0/7m.webp)
...
![Screenshot of the developer console with the 4 requests visible](../../images/0/8e.webp)
...
![Detailed view of the first request](../../images/0/9e.webp)
...
![Raw JSON Data](../../images/0/10e.webp)
...
![Formatted JSON output](../../images/0/11e.webp)
...
![Screenshot of the console tab on the developer console](../../images/0/12e.webp)

By clicking the little triangle at the beginning of the line, you can expand the text on the console.

![Screenshot of one of the previously collapsed entries expanded](../../images/0/13e.webp)
...
![A screenshot of the Elements tab of the developer console](../../images/0/14e.webp)
...
![document in console tab of developer tools](../../images/0/15e.webp)
...
![Screenshot of the page with the new note added to the list](../../images/0/16e.webp)
...
![Screenshot of the Elements tab on the developer console](../../images/0/17e.webp)
...
![developer tools elements tab showing CSS rules applied to container class](../../images/0/18e.webp)
...
![sequence diagram of browser/server interaction](../../images/0/19m.webp)
...
![form element highlight in webpage and developer tools](../../images/0/20e.webp)
...
![Screenshot of the Network tab where the events for submitting the form are shown](../../images/0/21e.webp)
...
![Detailed view of the first request](../../images/0/22e.webp)
...
![form data dropdown in developer tools](../../images/0/23g.webp)
...
![action and method highlight](../../images/0/24e.webp)
...
![form with missing action and method](../../images/0/25e.webp)
...
![Network tab showing one POST request to new_note_spa](../../images/0/26e.webp)
...
![highlight of Content-type header with application/json value](../../images/0/27e.webp)
