...
![Get request showing error in dev tools](../../images/3/3ae.webp)
...
![diagram of react app and browser](../../images/3/100_25.webp)
...
![Image showing the option to create a new Web Service](../../images/3/r1.webp)

The app repository is then connected to Render:

![Image showing the application repository on Render.](../../images/3/r2.webp)
...
![image showing the Root Directory field as optional](../../images/3/r3.webp)

After this, the app starts up in the Render. The dashboard tells us the app state and the url where the app is running:

![The top left corner of the image shows the status of the application and its URL](../../images/3/r4.webp)
...
![Menu with the option to deploy latest commit highlighted](../../images/3/r5.webp)

Also, the app logs can be seen in the dashboard:

![Image with the logs tab highlighted on the left corner. On the right side, the application logs](../../images/3/r7.webp)
...
![bash screenshot of ls showing dist directory](../../images/3/27v.webp)
...
![Notes application in localhost:3001](../../images/3/28new.webp)
...
![Network tab of notes application on backend](../../images/3/29new.webp)

The setup that is ready for a product deployment looks as follows:

![diagram of deployment ready react app](../../images/3/101.webp)
...
![screenshot of notes application](../../images/3/30new.webp)
...
![diagram of react app on fly.io](../../images/3/102.webp)
...
![Network dev tools showing a 404 on getting notes](../../images/3/32new.webp)
