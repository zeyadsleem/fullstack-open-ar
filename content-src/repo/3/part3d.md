...
![postman showing error message](../../images/3/50.webp)
...
![browser showing no notes appearing](../../images/3/fly-problem1.webp)
...
![fly.io server log showing connecting to undefined](../../images/3/fly-problem3.webp)
...
![render dashboard showing the MONGODB_URI env variable](../../images/3/render-env.webp)

The Render Dashboard shows the server logs:

![render dashboard with arrow pointing to server running on port 10000](../../images/3/r7.webp)
...
![phonebook screenshot showing person validation failure](../../images/3/56e.webp)
...
![terminal output from ESLint init](../../images/3/lint1.webp)
...
![terminal output of ESLint errors](../../images/3/53ea.webp)
...
![Screenshot of vscode ESLint plugin showing errors](../../images/3/54a.webp)
...
![terminal output from npm run lint](../../images/3/lint2.webp)
