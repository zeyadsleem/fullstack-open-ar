...
![hello world screen capture](../../images/3/1.webp)
...
![formatted JSON notes data](../../images/3/2new.webp)
...
![ls command listing of dependencies in directory](../../images/3/4.webp)
...
![network tab in dev tools](../../images/3/5.webp)
...
![api/notes gives the formatted JSON data again](../../images/3/6new.webp)
...
![node terminal demonstrating json is of type string](../../assets/3/5.webp)
...
![api/notes/1 gives a single note as JSON](../../images/3/9new.webp)

However, there's another problem with our application.

If we search for a note with an id that does not exist, the server responds with:

![network tools showing 200 and content-length 0](../../images/3/10ea.webp)
...
![postman screenshot on api/notes/2](../../images/3/11x.webp)
...
![get all notes rest file with get request on notes](../../images/3/12ea.webp)
...
![response from vs code from get request](../../images/3/13new.webp)
...
![postman post on api/notes with post content](../../images/3/14new.webp)

The application prints the data that we sent in the request to the console:

![terminal printing content provided in postman](../../images/3/15c.webp)
...
![console error about SyntaxError](../../images/3/16_25.webp)
...
![postman having text as content-type](../../images/3/17new.webp)

The <i>Content-Type</i> header is set to <i>text/plain</i>:

![postman showing headers and content-type as text/plain](../../images/3/18new.webp)

The server appears to only receive an empty object:

![console output showing empty curly braces](../../images/3/19_25.webp)
...
![sample post request in vscode with JSON data](../../images/3/20new.webp)
...
![GitHub screenshot of branch 3-1](../../images/3/21.webp)
...
![JSON data of 4 people in browser from api/persons](../../images/3/22e.webp)
...
![Screenshot for 3.2](../../images/3/23x.webp)
...
![terminal showing post data being sent](../../images/3/24.webp)
