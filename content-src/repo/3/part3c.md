...
![screenshot showing how to launch debugger in vscode](../../images/3/35x.webp)
...
![vscode screenshot of execution at a breakpoint](../../images/3/36x.webp)
...
![dev tools with green node logo icon](../../images/3/37.webp)
...
![dev tools sources tab breakpoint and watch variables](../../images/3/38eb.webp)
...
![dev tools console tab showing note object typed in](../../images/3/39ea.webp)
...
![mongodb picking shared, aws and region](../../images/3/mongo2.webp)
...
![mongodb security quickstart](../../images/3/mongo3.webp)
...
![mongodb network access/add ip access list](../../images/3/mongo4.webp)
...
![mongodb database deployment connect](../../images/3/mongo5.webp)
...
![mongodb connect application](../../images/3/mongo6new.webp)
...
![mongodb databases browse collections button](../../images/3/mongo7.webp)
...
![mongodb collections tab db myfirst app notes](../../images/3/mongo8new.webp)
...
![mongodb collections tab noteApp notes](../../images/3/mongo9.webp)
...
![node mongo.js outputs notes as JSON](../../images/3/70new.webp)
...
![api/notes in browser shows notes in JSON](../../images/3/44ea.webp)
...
![node output when wrong username/password](../../images/3/45e.webp)
...
![.gitignore in vscode with .env line added](../../images/3/45ae.webp)
...
![browser showing render environment variables](../../images/3/render-env.webp)
...
![VS code rest client doing a post](../../images/3/46new.webp)
...
![sample screenshot showing tiny slice of output](../../images/3/15b.webp)
...
![screenshot of browser showing one person with api/persons/their_id](../../images/3/49.webp)
