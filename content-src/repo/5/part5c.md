...
![node error that shows two elements with textbox since we use getByRole](../../images/5/40.webp)
...
![terminal output of test coverage](../../images/5/18new.webp)
...
![HTML report of the test coverage](../../images/5/19newer.webp)
