...
![cypress vs playwright in npm trends](../../images/5/pwc.webp)
...
![answer: javascript, tests, false, true](../../images/5/play0.webp)
...
![test report showing the test failing in three different browsers](../../images/5/play2.webp)

By clicking on the report of one of the browsers, we can see a more detailed error message:

![test error message](../../images/5/play3a.webp)
...
![playwright UI rendering the notes app while testing it](../../images/5/play4.webp)

After clicking, the form will appear

![playwright UI rendering the login form of the notes app](../../images/5/play5.webp)
...
![playwright inspector highlighting element found by the selected locator in the application](../../images/5/play6a.webp)
...
![playwright inspector showing the state of the application at page.pause](../../images/5/play6b.webp)
...
![playwright's trace viewer with red arrows pointing at the locator assisted search location and to the element selected with it showing a suggested locator for the element](../../images/5/play8.webp)
...
![playwright's record mode enabled with its output in the inspector after user interaction](../../images/5/play9.webp)
