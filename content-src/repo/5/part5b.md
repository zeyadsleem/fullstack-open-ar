...
![browser showing log in button by default](../../images/5/10e.webp)

The login form appears when the user presses the <i>login</i> button:

![user at login screen about to press cancel](../../images/5/11e.webp)
...
![browser of three togglable components](../../images/5/12e.webp)
...
![browser showing new note button with no form](../../images/5/13ae.webp)

It expands when button <i>create new blog</i> is clicked

![browser showing form with create new](../../images/5/13be.webp)
...
![browser showing full details of a blog with others just having view buttons](../../images/5/13ea.webp)
...
![browser showing missing name underneath like button](../../images/5/59put.webp)
...
![browser of confirmation of blog removal](../../images/5/14ea.webp)
