...
![browser showing user login for notes](../../images/5/1new.webp)
...
![browser showing user data in console saved in local storage](../../images/5/3e.webp)
...
![browser showing visible login form only](../../images/5/4e.webp)

If the user is logged-in, the name of the user and a list of blogs is shown.

![browser showing blogs and who is logged in](../../images/5/5e.webp)
...
![browser showing logout button after logging in](../../images/5/6e.webp)
...
![browser showing new blog form](../../images/5/7e.webp)
...
![browser showing successful operation notification](../../images/5/8e.webp)

Failed login can show the following notification:

![browser showing failed login attempt notification](../../images/5/9e.webp)
