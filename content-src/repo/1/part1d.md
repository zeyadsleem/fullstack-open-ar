...
![browser showing 2 left|right 1, RLL total 2](../../images/1/33.webp)
...
![devtools console showing left before 4 and left after 4](../../images/1/32.webp)
...
![screenshot of error pointing at the code line where it has been generated](../../images/1/6x.webp)
...
![debugger paused in dev tools](../../images/1/7a.webp)

By going to the <i>Console</i> tab, it is easy to inspect the current state of variables:

![console inspection screenshot](../../images/1/8a.webp)
...
![breakpoint example in devtools](../../images/1/9a.webp)
...
![screenshot react developer tools extension](../../images/1/10ea.webp)
...
![state of hooks in react dev tools](../../images/1/11ea.webp)
...
![using correct attribute names code screenshot](../../images/1/12f.webp)
...
![copilot input on vscode](../../images/1/gpt1.webp)

If the code looks good, Copilot adds it to the file:

![code added by copilot](../../images/1/gpt2.webp)
...
![copilot´s code suggestion](../../images/1/gpt3.webp)

In Copilot's chat window, it is possible to ask for an explanation of the function of the selected code area:

![copilot explaining how the selected code works in the chat window](../../images/1/gpt4.webp)
...
![copilot explaining the error and suggesting a fix](../../images/1/gpt5.webp)
...
![copilot creating a login component on request](../../images/1/gpt6.webp)
...
![Everyone knows that debugging is twice as hard as writing a program in the first place. So if you're as clever as you can be when you write it, how will you ever debug it? ― Brian Kernighan](../../images/1/kerningham.webp)
...
![screenshot of feedback options](../../images/1/13e.webp)
...
![average and percentage positive screenshot feedback](../../images/1/14e.webp)
...
![no feedback given text screenshot](../../images/1/15e.webp)
...
![screenshot of statistics table](../../images/1/16e.webp)

Remember to keep your console open at all times. If you see this warning in your console:

![console warning](../../images/1/17a.webp)
...
![random anecdote with next button](../../images/1/18a.webp)

<h4>1.13*: anecdotes step 2</h4>

Expand your application so that you can vote for the displayed anecdote.

![anecdote app with votes button added](../../images/1/19a.webp)
...
![anecdote with largest number of votes](../../images/1/20a.webp)
